...
<body>
    ...
    <div id="wrapper">
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="index.php?p=lihat_ujian"><i class="fa fa-pencil fa-fw"></i> Lihat Ujian Aktif<span class="fa arrow"></span></a>
                        </li>

                        <li>
                            <a href="index.php?p=lihat_nilai"><i class="fa fa-pencil fa-fw"></i> Lihat Nilai<span class="fa arrow"></span></a>
                        </li>
                    </ul>
                </div>
                <!-- /.sidebar-collapse -->
        ...
        <?php
        $cek = $dbcon->query("SELECT * FROM login_mhs WHERE id = '".$_SESSION['username']."' AND firsttime = 'YES'");
