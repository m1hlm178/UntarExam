                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            <div class="row">
                              <form action="./ext/save_soal.php" enctype="multipart/form-data" id="registrationForm" class="form-horizontal" role="form" method="post">
                                <!-- Select Basic -->
                                ...
                                <div class="form-group">
                                 ...
                                 <!-- Select Basic -->
                                <div class="form-group">
                                  <label class="col-lg-3 control-label">Soal:</label>
                                  <div class="col-lg-8">
                                    <select class="form-control" id="selectsoal" name="selectsoal" style="width:300px">
                                    <option value=""></option>
                                ...
                                <!-- Text input-->
                               <div class="form-group">
                                  <label class="col-lg-3 control-label">File Soal:</label>
                                  <div class="col-lg-8">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-md-8">
                                    <button class="btn btn-primary" type="submit" name="Upload-Soal" class="btn btn-primary btn-block">Simpan</button>
                                  </div>
                                </div>
                            </div>
                            </form>
